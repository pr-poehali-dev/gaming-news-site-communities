...
import { Topic, Tab, allTopics, forumCategories, categoryIcons } from './forum.types';
import ForumTopicPage from './ForumTopicPage';
import ForumNewTopicModal from './ForumNewTopicModal';
...
export default function ForumPage() {
  ...
  if (openTopic) {
    return <ForumTopicPage topic={openTopic} onBack={() => setOpenTopic(null)} />;
  }
