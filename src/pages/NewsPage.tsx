...
const categories = ['Все', 'Турниры', 'Обновления', 'Мобильные', 'Инди', 'Железо', 'Рейтинги', 'Киберспорт'];
...
const news: NewsItem[] = [
  ...
  {
    id: 101,
    title: 'Brawl Stars: новый сезон «Звёздный разлом» — все изменения и новые бравлеры Moe и Juju',
    category: 'Мобильные',
    time: '3 ч. назад',
    views: '41.2K',
    comments: 892,
    body: `Supercell официально запустила новый сезон Brawl Stars «Звёздный разлом». Главные изменения патча:\n\n**Новые бравлеры:**\n• Moe — необычный персонаж с механикой закапывания в землю. Наносит большой урон в ближнем бою, ульта — бурение через всю карту.\n• Juju — поддержка с возможностью создавать барьеры и лечить союзников на расстоянии. Особенность: её снаряды огибают препятствия.\n\n**Изменения баланса:**\n• Spike — урон супер-атаки +15%, теперь сильнее в Gem Grab\n• Colt — скорость снарядов +8%, легче попасть на дальних дистанциях\n• Nerfed: Lou (ульта замораживает на 0.5 сек меньше), Ash (ярость заряжается медленнее)\n\n**Новые скины:**\n• Legendary: «Космический Spike» и «Звёздная Janet»\n• Hypercharge для Sandy — ульта стала шире и длиннее\n\n**Событие сезона:**\nSpeedrun-режим где нужно пройти карты как можно быстрее. Топ-1000 получат эксклюзивный спрей.`,
    commentsList: [
      { id: 1, author: 'BrawlPro_RU', text: 'Moe выглядит сломанным, закопка под землёй даёт слишком много преимуществ', time: '2 ч. назад', likes: 567 },
      { id: 2, author: 'JujuMain', text: 'Juju просто красавица, наконец нормальный сапорт в игре!', time: '1 ч. назад', likes: 312 },
      { id: 3, author: 'BS_veteran', text: 'Нерф Lou — справедливо, он был имбой в контроле зон', time: '45 мин назад', likes: 189 },
    ],
  },
  {
    id: 102,
    title: 'PUBG Mobile: сезон C7S20 — новая карта Rondo, Vikendi 2.0 и изменения рейтинга',
    category: 'Мобильные',
    time: '6 ч. назад',
    views: '28.7K',
    comments: 445,
    body: `Новый сезон PUBG Mobile C7S20 принёс масштабные обновления.\n\n**Новая карта Rondo:**\nАзиатский город с плотной городской застройкой, традиционными рынками и небоскрёбами. Особенность: канатные дороги между крышами для быстрого перемещения. Размер 8x8 км.\n\n**Vikendi 2.0:**\nПолная переработка снежной карты: новые деревни, расширенная центральная часть, удалены часть «мёртвых зон». Снег теперь динамически реагирует на ходьбу.\n\n**Система рейтинга — изменения:**\n• Новый ранг «Immortal» выше Conqueror — топ 100 игроков сервера\n• Очки рейтинга: +10% за survival time, -5% штраф за AFK\n• Новая система «горячей серии»: 3 победы подряд дают бонус +50 очков\n\n**Оружие:**\n• Новый дробовик Vector Shotgun — режим очередью 3 выстрела\n• HK416 заменяет M416 в некоторых регионах карты\n\n**Коллаборация:**\nСезон включает коллаборацию с аниме «One Piece» — скины Luffy, Zoro и Nami.`,
    commentsList: [
      { id: 1, author: 'PUBGmobile_fan', text: 'Rondo выглядит отлично, наконец карта с настоящим городом!', time: '5 ч. назад', likes: 423 },
      { id: 2, author: 'Conqueror_RU', text: 'Ранг Immortal — хорошая идея, Conqueror слишком доступен стал', time: '4 ч. назад', likes: 234 },
    ],
  },
  {
    id: 103,
    title: 'Clash Royale: глобальный турнир Kings Cup 2025 — $500 000 призовых',
    category: 'Мобильные',
    time: '10 ч. назад',
    views: '19.4K',
    comments: 321,
    body: `Supercell анонсировала крупнейший турнир в истории Clash Royale — Kings Cup 2025 с призовым фондом $500 000.\n\n**Формат:**\n• Квалификации: июнь–июль 2025, онлайн по регионам\n• Финал: август 2025, Токио, 16 команд\n• Россия и СНГ — отдельный региональный квалификатор\n\n**Правила изменены:**\n• Best-of-5 в плей-офф (было Bo3)\n• Запрет на повтор колоды в одном матче\n• 10-минутный таймаут для анализа колоды соперника\n\n**Топ-игроки СНГ:**\n• KAIROS_RU — текущий лидер рейтинга СНГ, колода Hog Cycle\n• DarkQueen_BY — специализация на X-Bow Siege\n• MobileKing_KZ — агрессивный Giant Double Prince\n\n**Призовые:**\n• 1 место: $150 000\n• 2 место: $75 000\n• 3–4 место: $40 000\n• 5–8 место: $20 000`,
    commentsList: [
      { id: 1, author: 'CR_player', text: '$500к для мобильной игры — это серьёзно! Clash Royale выходит на уровень больших турниров', time: '8 ч. назад', likes: 678 },
      { id: 2, author: 'SNGesports', text: 'KAIROS_RU точно попадёт в финал, его Hog Cycle непробиваем', time: '6 ч. назад', likes: 234 },
    ],
  },
  {
    id: 104,
    title: 'Genshin Impact 5.5: новый регион Натлан расширяется — Arlecchino становится разыгрываемой',
    category: 'Мобильные',
    time: '14 ч. назад',
    views: '67.3K',
    comments: 1892,
    body: `HoYoverse раскрыла детали обновления Genshin Impact версии 5.5.\n\n**Новые персонажи:**\n• Arlecchino (Пиро/Копьё) — один из Fatui Harbinger становится разыгрываемым. Механика: поглощает HP врагов для усиления атак\n• Chiori (Гео/Меч) — новый 5-звёздочный с уникальными куклами-конструктами\n\n**Новый регион Натлан — расширение:**\n• Биом «Тёмный лес» с ночными механиками — новые враги активны только в темноте\n• Подземный город Каикиса — 15 новых исследовательских точек\n• 42 Primogem'а за исследование (суммарно ~2500 из всей версии)\n\n**Новое оружие:**\n• «Праймовая охота» — 5-звёздочное копьё под Arlecchino\n• Билд: HP%/HP%/Крит Шанс + набор «Бледный огонь» (4)\n\n**Ивенты:**\n• «Огненный фестиваль» — 1600 Primogem'ов бесплатно\n• Повторный запуск ивента с рыбалкой`,
    commentsList: [
      { id: 1, author: 'GenshinWhale', text: 'Arlecchino наконец-то! Ждал с версии 4.6, уже 20к примо отложил', time: '12 ч. назад', likes: 2341 },
      { id: 2, author: 'F2P_Traveler', text: '1600 примо за ивент — спасибо HoYo, чуть пополнят запасы', time: '11 ч. назад', likes: 876 },
      { id: 3, author: 'LoreHunter', text: 'Arlecchino в лоре — одна из самых интригующих фигур, не могу дождаться её истории', time: '10 ч. назад', likes: 445 },
    ],
  },
  {
    id: 8,
